...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            <h1 class="page-title">Science Coaching in Jamia Nager | Okhla
            </h1>
            <!-- <ul>
                <li>
                ...
                <div class="col-lg-8 pr-50 md-pr-15">
                    <div class="blog-deatails">
                        <!-- <div class="blog-full">
                            ...
                            <div> -->
                        <h2 class="title">Science Coaching in Jamia Nager | Okhla</h2>
                    </div>
                    <div class="blog-desc">
                        <p>
