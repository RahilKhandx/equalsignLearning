                ...
                <div class="col-lg-4 lg-pr-0 md-mb-30">
                    <div class="about-intro">
                        <div class="sec-title">
                            ...
                            <div class="desc big">
                                <p>
                                    The key to success is to appreciate how people learn, understand the thought process
                                    that goes into instructional design, what works well, and a range of difference.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="course-wrap">
                        <div class="front-part">
                            ...
                            <div class="content-part">
                                ...
                                <h4 class="title"><a href="course-single.html">"Propel your engineering dreams with our
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="course-wrap">
                        ...
                        <div class="inner-part">
                            <div class="content-part">
                                <a class="categorie" href="#">NEET-UG</a>
                                <h4 class="title"><a href="course-single.html">"Excel in NEET UG with expert coaching
                    ...
                    <div class="course-wrap">
                        <div class="front-part">
                            ...
                            <div class="content-part">
                                ...
                                <h4 class="title"><a href="course-single.html">"Achieve Top University Admissions with
                    ...
                    <div class="notice-bord style1">
                        ...
                        <ul>
                            ...
                            <li class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                                <div class="date"><i class="fa fa-user" aria-hidden="true" style="font-size: 30px"></i>
                                </div>
                            ...
                            <li class="wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2000ms">
                                <div class="date"><i class="fa fa-book" aria-hidden="true" style="font-size: 30px"></i>
                                </div>
                        ...
                        <div class="notice-board container">
                            ...
                            <div class="notice-wrapper">
                                <div class="notice-content">
                                    ...
                                    <div class="notice-item">Notice 2: Library will be closed for maintenance on 10th
                                        January.</div>
                                    <div class="notice-item">Notice 3: Registration for the winter camp is open.</div>
                                    <div class="notice-item">Notice 4: Exam schedule has been released, check the
                                        website.</div>
                                    <div class="notice-item">Notice 5: Special guest lecture on 12th January at 3 PM.
                                    </div>
                                    <div class="notice-item">Notice 1: New classes start from 15th January!</div>
                                    <div class="notice-item">Notice 2: Library will be closed for maintenance on 10th
                                        January.</div>
