...
<div class="rs-breadcrumbs breadcrumbs-overlay">
    ...
    <div class="breadcrumbs-text white-color">
        <h1 class="page-title">Class 8th</h1>
        <ul>
            <li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pr-50 md-pr-15">
                <div class="blog-deatails">
                    <div class="bs-img">
                        <a href="#"><img src="assets/images/Class8thCourseDetails.jpg"alt="" class="wow fadeInUp"></a>
                    </div>
                  
                    <h2 class="title">Class 8th Course Details</h2>
                </div>
                <div class="blog-desc ">
                    <p>
                ...
                <div class="container">
                    ...
                    <p>Join Equalsign Learning's Class 8 program to set the foundation for a future of academic
                        brilliance
...
<p>
                    ...
                    <h2 style="text-align: center;">Class 8th Subjects and Resources</h2>
                    <table>
                        <tr>
                            <th>Subject</th>
                            <th>Content/Links</th>
