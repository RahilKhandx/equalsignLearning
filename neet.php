...
<div class="rs-breadcrumbs breadcrumbs-overlay">
    ...
    <div class="breadcrumbs-text white-color">
        <h1 class="page-title">NEET UG</h1>
        <ul>
            <li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pr-50 md-pr-15">
                <div class="blog-deatails">
                    <h2 class="title">NEET UG Coaching:<br> Nurturing Medical Aspirations, Ensuring Excellence</h2>
                </div>
                <div class="blog-desc ">
                    <p>
                    ...
                    <div class="row wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                        <div class="col-md-6">
                            ...
                            <h4 class="title" style="color: #EF481B;">Key Features:</h4>
                                ...
                                <ul class="name-list">
                                    <li><span class="checkmark">&#10003;</span> Comprehensive Subject Coverage: In-depth coaching in Biology, Physics, and Chemistry, covering the NEET UG syllabus comprehensively.</li>
                                    <li><span class="checkmark">&#10003;</span> Expert Faculty: Learn from experienced educators with a deep understanding of the medical entrance exam landscape, guiding students toward success.</li>
                                    <li><span class="checkmark">&#10003;</span> Strategic Exam Preparation: Tailored coaching that aligns with the NEET UG exam pattern, focusing on efficient time management and effective problem-solving strategies.</li>
                                    <li><span class="checkmark">&#10003;</span> Practical Application of Knowledge: Emphasis on the application of theoretical knowledge in practical scenarios, preparing students for the real challenges of medical studies.</li>
                                    <li><span class="checkmark">&#10003;</span>   Regular Mock Tests: Gauge exam readiness through regular mock tests that simulate the actual NEET UG exam environment.</li>
                                </ul>
                            </section>
                        </div>
                        <div class="col-md-6 ">
                            <section class="name-list-section">
                                <ul class="name-list" style="margin-top:50px">
                                    <li><span class="checkmark">&#10003;</span>Doubt Resolution Sessions: Dedicated sessions to address queries and clarify doubts, ensuring a thorough understanding of complex medical concepts.</li>
                                    <li><span class="checkmark">&#10003;</span> Individualized Attention: Benefit from small class sizes, facilitating personalized attention and fostering a supportive learning environment. </li>
                                    <li><span class="checkmark">&#10003;</span>Technology-Enhanced Learning: Leverage modern teaching tools and technology to enhance the learning experience, making complex medical concepts more accessible. </li>
                                    ...
                                    <li><span class="checkmark">&#10003;</span> Comprehensive Study Material: Access well-structured study materials that cover the entire NEET UG syllabus, aiding effective revision and preparation.</li>
                                </ul>
                            </section>
                        </div>
                    </div>
